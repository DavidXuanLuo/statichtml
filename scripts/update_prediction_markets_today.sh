...
/usr/bin/git add data/prediction-markets-today.json prediction-markets-today.html scripts/generate_prediction_markets_today.py scripts/update_prediction_markets_today.sh
